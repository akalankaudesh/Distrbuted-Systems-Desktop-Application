...
import lk.nsbm.com.jr.view.util.ItemTM;
...
public class ManageItemFormController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        tblItems.getColumns().get(0).setStyle("-jr-alignment: center");
        tblItems.getColumns().get(2).setStyle("-jr-alignment: center-right");
        tblItems.getColumns().get(3).setStyle("-jr-alignment: center-right");
...
//        }
    ...
    public void btnReport_OnAction(ActionEvent actionEvent) throws SQLException, JRException {
        HashMap<String, Object> params = new HashMap<>();
        params.put("totalItems", tblItems.getItems().size());
        JasperUtil.showReport(JasperUtil.REPORT_ITEM,
                params,
                new JRBeanCollectionDataSource(tblItems.getItems()));
    }
}
